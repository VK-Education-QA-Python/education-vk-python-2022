...
class TestLoad(BaseCase):
    ...
    def test_download(self):
        self.driver.get('https://www.python.org/downloads/release/python-3107/')
        time.sleep(5)
        self.main_page.click((By.XPATH, '//a[@href="https://www.python.org/ftp/python/3.10.7/python-3.10.7-embed-amd64.zip"]'))
        time.sleep(10)
